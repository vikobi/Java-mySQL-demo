...
- Secret data as Jenkins credentials with Kind: _"secret text"_ and credential ids: _"db_user"_, _"db_pass"_, _"db_name"_, "db_root_pass" that Jenkins will use to set secret data values
